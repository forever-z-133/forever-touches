...
export const AlloyFingerTrggers = new Map();
export default class AlloyFinger extends Component {
  ...
  componentWillUnmount() {
    window.removeEventListener('touchstart', this._handleTouchPrevent, { passive: false });
    ...
    window.removeEventListener('touchcancel', this._handleTouchCancel);
  }
  ...
  _canTriggerMe(evt) {
    return AlloyFingerTrggers.has(this.dom);
  }
